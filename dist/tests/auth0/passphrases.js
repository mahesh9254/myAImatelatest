...
const passphrases = require("../../lib/auth0/passphrases");
const dictionary_1 = require("../../lib/utils/dictionary");
describe('passphrases generator', () => {
    ...
    it('should not modify the dictionary when generating passphrases', () => {
        const firstInDictBefore = dictionary_1.WORDS[0];
        passphrases.generate();
        const firstInDictAfter = dictionary_1.WORDS[0];
