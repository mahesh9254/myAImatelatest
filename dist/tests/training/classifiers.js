...
const classifiers = require("../../lib/training/classifiers");
describe('Training - Unmanaged classifiers', () => {
    ...
    const convCredentials = dbobjects.createBluemixCredentials(conv, CLASSID, undefined, username, password, 'conv_lite');
    const visrecCredentials = dbobjects.createBluemixCredentials(visrec, CLASSID, apikey, undefined, undefined, 'visrec_lite');
    ...
    const mockConversation = {
        ...
        deleteClassifier: (url) => {
            assert.strictEqual(url, 'https://gateway.watsonplatform.net/conversation/api/v1/workspaces/' + validWorkspace.workspace_id);
            return Promise.resolve();
        },
    };
    const mockVisRec = {
