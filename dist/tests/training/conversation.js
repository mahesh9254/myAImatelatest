...
describe('Training - Conversation', () => {
    ...
    let updateScratchKeyTimestampStub;
    let getClassStub;
    let isTenantDisruptiveStub;
    before(() => {
        // @ts-ignore
    ...
    describe('create classifier', () => {
        it('should create a classifier', async () => {
            ...
            assert(storeScratchKeyStub.calledWith(project, mockstore.creds, '04f2d303-16fd-4f2e-80f4-2c66784cc0fe', sinon.match.any));
        });
    ...
    describe('update classifier', () => {
        it('should update a classifier', async () => {
            ...
            const classifier = await conversation.trainClassifier(project);
            assert.notStrictEqual(existingClassifier.expiry.getTime(), classifier.expiry.getTime());
