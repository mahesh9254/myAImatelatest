...
const deployment = require("../../lib/utils/deployment");
describe('Training - numbers service', () => {
    ...
    describe('test classifier', () => {
        it('should check the range of numbers for the numbers service', async () => {
            ...
            try {
                await numbers.testClassifier(USERID, CLASSID, new Date(), project.id, [1, 204040404040404040404040404040404040404040404040404040404040404040404040404040000000000000, 3]);
    ...
    describe('create classifier', () => {
        ...
        it('should handle test failures due to missing training', async () => {
            ...
            const classifications = await numbers.testClassifier(USERID, CLASSID, classifierTimestamp, project.id, [10, 5, 0.5]);
