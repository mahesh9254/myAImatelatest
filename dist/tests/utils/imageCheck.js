...
const imageCheck = require("../../lib/utils/imageCheck");
describe('Utils - imageCheck', () => {
    ...
    it('should reject images that exceed size limits', (done) => {
        imageCheck.verifyImage(VALID_JPG, 8000)
            ...
            .catch((err) => {
            assert.strictEqual(err.message, 'Image file size (8.71 KB) is too big. Please choose images smaller than 7.81 KB');
            done();
        });
    });
});
