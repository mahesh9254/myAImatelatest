...
const wikimedia = require("../../lib/utils/wikimedia");
describe('Utils - wikimedia', () => {
    ...
    const VALID_THUMBS = [
        'https://upload.wikimedia.org/wikipedia/commons/thumb/f/fd/Playing_card_diamond_5.svg/2000px-Playing_card_diamond_5.svg.png',
    ...
    const EXPECTED_THUMB_THUMBS = [
        'https://upload.wikimedia.org/wikipedia/commons/thumb/f/fd/Playing_card_diamond_5.svg/244px-Playing_card_diamond_5.svg.png',
