...
const extensions = require("../../lib/scratchx/extensions");
describe('Scratchx - status', () => {
    describe('text projects', () => {
        it('should create a text classify extension', async () => {
            ...
            assert(extension.indexOf('[ \'R\', \'recognise text %s (label)\', \'text_classification_label\', \'text\' ]') > 0);
            assert(extension.indexOf('[ \'R\', \'recognise text %s (confidence)\', \'text_classification_confidence\', \'text\' ]') > 0);
        });
    ...
    describe('images projects', () => {
        it('should create a images classify extension', async () => {
            ...
            assert(extension.indexOf('[ \'R\', \'recognise image %s (label)\', \'image_classification_label\', \'image\' ]') > 0);
        });
    });
});
