(function () {
    ...
    function config($stateProvider, lockProvider, $urlRouterProvider, jwtOptionsProvider, $httpProvider, $translateProvider) {
        ...
        $stateProvider
            .state('home', {
                url: '',
                templateUrl: 'static/components-1579166330521/welcome/welcome.html'
            })
            .state('welcome', {
                url: '/welcome',
                templateUrl: 'static/components-1579166330521/welcome/welcome.html'
            ...
            .state('login', {
                ...
                templateUrl: 'static/components-1579166330521/login/login.html',
                controllerAs: 'vm',
                params: {
                    DEPLOYMENT : ''
                }
            ...
            .state('signup', {
                ...
                templateUrl: 'static/components-1579166330521/signup/signup.html',
                controllerAs: 'vm',
                params: {
                    DEPLOYMENT : ''
                }
            ...
            .state('about', {
                url: '/about',
                templateUrl: 'static/components-1579166330521/about/about.html'
            })
            .state('news', {
                url: '/news',
                templateUrl: 'static/components-1579166330521/news/news.html'
            })
            .state('help', {
                url: '/help',
                templateUrl: 'static/components-1579166330521/help/help.html'
            })
            .state('apikeysguide', {
                url: '/apikeys-guide',
                templateUrl: 'static/components-1579166330521/apikeysguide/guide.html'
            })
            .state('worksheets', {
                url: '/worksheets',
                controller: 'WorksheetsController',
                templateUrl: 'static/components-1579166330521/worksheets/worksheets.html',
                controllerAs: 'vm',
                params: {
                    VERSION : 1579166330521
                }
            })
            .state('teacher', {
                url: '/teacher',
                controller: 'TeacherController',
                templateUrl: 'static/components-1579166330521/teacher/teacher.html',
                controllerAs: 'vm'
            })
            .state('teacher_restrictions', {
                url: '/teacher/restrictions',
                controller: 'TeacherRestrictionsController',
                templateUrl: 'static/components-1579166330521/teacher_restrictions/teacher_restrictions.html',
                controllerAs: 'vm',
                params: {
                    VERSION : 1579166330521
                }
            ...
            .state('teacher_apikeys', {
                ...
                templateUrl: 'static/components-1579166330521/teacher_apikeys/teacher_apikeys.html',
                controllerAs: 'vm',
                params: {
                    VERSION : 1579166330521
                }
            ...
            .state('teacher_students', {
                ...
                templateUrl: 'static/components-1579166330521/teacher_students/teacher_students.html',
                controllerAs: 'vm',
                params: {
                    VERSION : 1579166330521
                }
            ...
            .state('teacher_supervision', {
                ...
                templateUrl: 'static/components-1579166330521/teacher_supervision/teacher_supervision.html',
                controllerAs: 'vm'
            })
            .state('newproject', {
                url: '/newproject',
                controller: 'NewProjectController',
                templateUrl: 'static/components-1579166330521/newproject/newproject.html',
                controllerAs: 'vm'
            })
            .state('importdataset', {
                url: '/importdataset',
                controller: 'DatasetsController',
                templateUrl: 'static/components-1579166330521/datasets/datasets.html',
                controllerAs: 'vm',
                params: {
                    VERSION : 1579166330521
                }
            ...
            .state('projects', {
                ...
                templateUrl: 'static/components-1579166330521/projects/projects.html',
                controllerAs: 'vm'
            })
            .state('mlproject', {
                url: '/mlproject/:userId/:projectId',
                controller: 'ProjectController',
                templateUrl: 'static/components-1579166330521/mlproject/mlproject.html',
                controllerAs: 'vm'
            })
            .state('mlproject_training', {
                url: '/mlproject/:userId/:projectId/training',
                controller: 'TrainingController',
                templateUrl: 'static/components-1579166330521/training/training.html',
                controllerAs: 'vm',
                params: {
                    VERSION : 1579166330521
                }
            ...
            .state('mlproject_models', {
                ...
                templateUrl: 'static/components-1579166330521/models/models.html',
                controllerAs: 'vm',
                params: {
                    VERSION : 1579166330521
                }
            ...
            .state('mlproject_model_describe', {
                ...
                templateUrl: 'static/components-1579166330521/describemodel/describemodel.html',
                controllerAs: 'vm',
                params: {
                    VERSION : 1579166330521
                }
            ...
            .state('mlproject_makes', {
                ...
                templateUrl: 'static/components-1579166330521/makes/makes.html',
                controllerAs: 'vm'
            })
            .state('mlproject_scratch', {
                url: '/mlproject/:userId/:projectId/scratch',
                controller: 'ScratchController',
                templateUrl: 'static/components-1579166330521/scratch/scratch.html',
                controllerAs: 'vm'
            })
            .state('mlproject_scratch3', {
                url: '/mlproject/:userId/:projectId/scratch3',
                controller: 'Scratch3Controller',
                templateUrl: 'static/components-1579166330521/scratch3/scratch3.html',
                controllerAs: 'vm'
            })
            .state('mlproject_python', {
                url: '/mlproject/:userId/:projectId/python',
                controller: 'PythonController',
                templateUrl: 'static/components-1579166330521/python/python.html',
                controllerAs: 'vm'
            })
            .state('mlproject_appinventor', {
                url: '/mlproject/:userId/:projectId/appinventor',
                controller: 'AppInventorController',
                templateUrl: 'static/components-1579166330521/appinventor/appinventor.html',
                controllerAs: 'vm'
            })
            .state('links', {
                url: '/links',
                templateUrl: 'static/components-1579166330521/links/links.html#top'
            })
            .state('404', {
                url: '/404',
                templateUrl: 'static/components-1579166330521/404/404.html'
            })
            .state('siteadmin', {
                url: '/siteadmin',
                controller: 'AdminController',
                templateUrl: 'static/components-1579166330521/admin/admin.html',
                controllerAs: 'vm'
            });
        ...
        $translateProvider
            ...
            .useStaticFilesLoader({
                prefix: 'static/languages-1579166330521/',
                suffix: '.json'
            })
